...
→ [01](curriculum/01-python-and-data-tooling.md) · `make run M=01`
...
→ [02](curriculum/02-machine-learning-foundations.md) · `make run M=02`
...
→ [03](curriculum/03-supervised-learning-algorithms.md) · `make run M=03`
...
→ [04](curriculum/04-unsupervised-learning.md) · `make run M=04`
...
→ [05](curriculum/05-model-evaluation-and-tuning.md) · `make run M=05`
...
→ [08](curriculum/08-training-and-regularizing-networks.md) · `make run M=08`
...
### m10 · RNNs & Sequences
→ [10](curriculum/10-rnn-and-sequence-modeling.md) · `make run M=10`
...
→ [11](curriculum/11-transformers-and-foundation-models.md) · `make run M=11`
...
→ [12](curriculum/12-generative-models.md) · `make run M=12`
...
→ [14](curriculum/14-large-language-models.md) · `make run M=14`
...
→ [16](curriculum/16-prompt-engineering.md) · `make run M=16`
...
→ [18](curriculum/18-ai-agents-and-tool-use.md) · `make run M=18`
...
→ [20](curriculum/20-multimodal-ai.md) · `make run M=20`
...
→ [23](curriculum/23-advanced-and-specialized-topics.md) · `make run M=23`
...
→ [25](curriculum/25-ml-system-design.md) · `make run M=25`
...
→ [26](curriculum/26-ml-interview-prep-and-coding.md) · `make run M=26`
