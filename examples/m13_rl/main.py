"""m13 — Reinforcement learning: Q-learning on a gridworld learns an optimal policy.

Proves theory doc 13-reinforcement-learning.md: MDPs, TD updates, epsilon-greedy
exploration, and convergence to the value of the goal.
"""
import sys
...
def main():
    ...
    print(f"PASS m13 rl | return early={early:.2f} -> late={late:.2f} "
          ...
          f"V_start={V[0,0]:.3f} V_goal={V[GOAL]:.3f} policy={flat}")
