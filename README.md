...
make notebook              # open the module-00 MATH NOTEBOOK in JupyterLab (52 cells, all graphs)
...
| [`docs/figures/`](docs/figures/) | Generated didactic figures — 32 diagrams for module 00's math topics (`python3 tools/make_math_figures.py`); every worked number verified by `tools/calc_00_math.py` |
